...
class PengembalianBarangController extends Controller
{
    ...
    public function surat_jalan(Penyewaan $model)
    {
        ...
        // return view('administrasi.pengembalian.surat_jalan', compact('page_attr', 'model', 'surat_jalan', 'surat_jalan_barangs', 'customer'));
        view()->share('administrasi.pengembalian.surat_jalan', compact('page_attr', 'model', 'surat_jalan', 'surat_jalan_barangs', 'customer'));
        $pdf = PDF::loadView('administrasi.pengembalian.surat_jalan', compact('page_attr', 'model', 'surat_jalan', 'surat_jalan_barangs', 'customer'))
