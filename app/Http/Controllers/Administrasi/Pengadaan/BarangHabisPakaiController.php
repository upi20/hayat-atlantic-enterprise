...
class BarangHabisPakaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('administrasi.pengadaan.barang_habis_pakai', compact('page_attr'));
    }
    ...
    public function delete(Pengadaan $model): mixed
    {
        try {
            ...
            foreach ($pengadaan_list as $pengadaan) {
                $barang = HabisPakai::findOrFail($pengadaan->barang);
                $barang->qty = $barang->qty - $pengadaan->qty;
                $barang->save();
                $pengadaan->delete();
            }
