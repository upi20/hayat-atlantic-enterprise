        ...
        function refresh_bhs_list() {
            ...
            $.ajax({
                ...
                data.forEach(bhs => {
                    ...
                    const btn_update = can_barang_habis_pakai_update ? `<button type="button" data-toggle="tooltip" class="btn btn-rounded btn-primary btn-sm me-1" title="Ubah Data"onClick="editFunc('${bhs.id}')">
                                <i class="fas fa-edit"></i>
                                </button>` : '';
                    const btn_delete = can_barang_habis_pakai_delete ? `<button type="button" data-toggle="tooltip" class="btn btn-rounded btn-danger btn-sm me-1" title="Hapus Data" onClick="deleteFunc('${bhs.id}')">
