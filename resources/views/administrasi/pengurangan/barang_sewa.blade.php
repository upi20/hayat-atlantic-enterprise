                ...
                columns: [{
                    ...
                    ...(can_update || can_delete ? [{
                        ...
                        render(data, type, full, meta) {
                            ...
                            const btn_update = can_update && full.penyewaan == null ? `<button type="button" class="btn btn-rounded btn-primary btn-sm me-1 mt-1" title="Edit Data" onClick="editFunc('${data}')">
                                <i class="fas fa-edit"></i> Ubah
                                </button> ${(++br_counter %2==0)? '<br>':''}` : '';
                            const btn_delete = can_delete && full.penyewaan == null ? `<button type="button" class="btn btn-rounded btn-danger btn-sm me-1 mt-1" title="Delete Data" onClick="deleteFunc('${data}')">
