...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('barang_habis_pakai_pengurangan_list', function (Blueprint $table) {
            $table->id();
            $table->integer('qty');
            ...
            $table->foreign('pengurangan')->references('id')->on('barang_habis_pakai_pengurangan')->cascadeOnDelete()->cascadeOnUpdate();
