...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('barang_pengadaan_list', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('pengadaan')->references('id')->on('barang_pengadaan')->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('barang_pengadaan_list');
    }
};
